...
public class AppointmentCheck extends AppCompatActivity {
    ...
    final progressBar progressBar = new progressBar(AppointmentCheck.this);
    String UserId;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("AppointmentSet").child(UserId);
    ...
    private void collectFirebaseData(Map<String,Object> value){
        for (Map.Entry<String ,Object>entry:value.entrySet()){
            ...
            govHospotalItems.add(new GovHospotalItems(String.valueOf("Doctor: "+SingleData.get("name")),"Date: "+String.valueOf(SingleData.get("date"))+"\nTime: "+ String.valueOf(SingleData.get("time")),"Workplace: "+String.valueOf(SingleData.get("workPlace"))+"    "+"\nStatus: "+String.valueOf(SingleData.get("status"))));
        }

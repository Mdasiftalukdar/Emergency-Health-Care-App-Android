...
public class FindAmbulance extends AppCompatActivity {
    ...
    final progressBar progressBar = new progressBar(FindAmbulance.this);
    String UserId;
    FirebaseAuth fAuth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("FindAmbulance");
    ...
    private void collectFirebaseData(Map<String,Object> value){
        for (Map.Entry<String ,Object>entry:value.entrySet()){
            ...
            govHospotalItems.add(new GovHospotalItems(String.valueOf(SingleData.get("AmbulanceName")),String.valueOf(SingleData.get("address")),String.valueOf(SingleData.get("phone"))));
        }
